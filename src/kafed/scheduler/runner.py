"""KAFED Scheduler — TaskRunner：執行 + 補償引擎。
...
from kafed.scheduler.registry import Task, TaskResult, registry

logger = logging.getLogger("kafed.scheduler.runner")
...
class TaskRunner:
    ...
    def bootstrap(self) -> list[TaskResult]:
        ...
        在 kafed-bootstrap 和 session_start 時調用。
