...
用法:
    ...
    path = pack_domain("SAP_PM")  # → ~/.loom/data/kpak/SAP_PM.kpak
"""
...
logger = logging.getLogger("loom.kpak.pack")
...
def pack_domain(
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if include_centroid:
            try:
                from loom.knowledge.classify.classify import build_centroids_from_labels
